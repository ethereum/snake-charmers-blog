...
No matter how complex a smart contract system is, it can be packaged up and distributed with EthPM, making it trivial for developers all around the world to start building on top of your contracts (hint hint, anybody who wants other devs to build dapps on top of their protocol).
...
```python
# Voila! In one line, you have deployed your very own registry
# Please be sure to save this address!
# While this will automatically set your freshly deployed registry
# as the active registry on your w3.pm instance, but please save your contract address for future reference
